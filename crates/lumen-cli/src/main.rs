...
fn render_config(preset: Preset, region: &str, backend: Backend, cache_dir: &Path) -> String {
    ...
    if preset.includes_fastvlm {
        services.insert(3, "fastvlm");
    }
    ...
    yaml.push_str("  # Minimum: RAM 3 GB, GPU/Unified memory 2 GB.\n");
    yaml.push_str("  siglip:\n");
    yaml.push_str("    enabled: true\n");
    yaml.push_str("    package: siglip\n");
    yaml.push_str("    models:\n");
    yaml.push_str("      default:\n");
    yaml.push_str("        model: siglip2-base-patch16-224\n");
    ...
    if preset.includes_fastvlm {
        yaml.push('\n');
        yaml.push_str("  # Minimum: RAM 6 GB, GPU/Unified memory 4 GB.\n");
        yaml.push_str("  fastvlm:\n");
        yaml.push_str("    enabled: true\n");
        yaml.push_str("    package: fastvlm\n");
        yaml.push_str("    models:\n");
        yaml.push_str("      default:\n");
        yaml.push_str("        model: fast-vlm-0.5b\n");
        yaml.push_str("        runtime: onnx\n");
        yaml.push_str("        precision: fp16\n");
    }
...
impl Preset {
    fn all() -> &'static [Self] {
        &[
            ...
            Self {
                name: "brave",
                components: &["siglip", "ocr", "face", "fastvlm", "bioclip"],
                min_ram_gb: 32,
                min_vram_gb: 12,
                min_disk_gb: 40,
                includes_bioclip: true,
                includes_fastvlm: true,
            },
        ]
    }
