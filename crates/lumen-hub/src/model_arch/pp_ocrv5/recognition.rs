...
impl<B: Backend> Default for Model<B> {
    fn default() -> Self {
        Self::from_file(
            "/Volumes/CodeBase/Projects/Burn-Convert/burn_onnx_demo/target/debug/build/burn_onnx_demo-ee3ae3084d17995b/out/model/ppocrv5-recognition/recognition.bpk",
            &Default::default(),
        )
    }
}
