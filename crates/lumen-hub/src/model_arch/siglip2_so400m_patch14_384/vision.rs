// Generated from ONNX "src/siglip2-so400m/vision.fp32.onnx" by burn-onnx
use burn::nn::Linear;
...
impl<B: Backend> Submodule1<B> {
    ...
    pub fn new(device: &B::Device) -> Self {
        let conv2d1 = Conv2dConfig::new([3, 1152], [14, 14])
            .with_stride([14, 14])
        ...
        let constant4: burn::module::Param<Tensor<B, 3>> = burn::module::Param::uninitialized(
            ...
            move |device, _require_grad| {
                Tensor::<B, 3>::zeros([1, 729, 1152], (device, burn::tensor::DType::F32))
            },
            device.clone(),
            false,
            [1, 729, 1152].into(),
    ...
    pub fn forward(
        ...
        let reshape1_out1 = conv2d1_out1.reshape([-1, 1152, 729]);
        ...
        let add6_out1 = (constant14_out1)
            .unsqueeze_dims(&[0isize, 1isize])
            .add(linear3_out1);
        let reshape2_out1 = add4_out1.reshape([-1, 729, 16, 72]);
        let reshape3_out1 = add5_out1.reshape([-1, 729, 16, 72]);
        let reshape4_out1 = add6_out1.reshape([-1, 729, 16, 72]);
        ...
        let reshape5_out1 = transpose5_out1.reshape([-1, 729, 1152]);
...
impl<B: Backend> Submodule2<B> {
    ...
    pub fn forward(
        ...
        let add17_out1 = (constant37_out1)
            .unsqueeze_dims(&[0isize, 1isize])
            .add(linear9_out1);
        let reshape6_out1 = add15_out1.reshape([-1, 729, 16, 72]);
        let reshape7_out1 = add16_out1.reshape([-1, 729, 16, 72]);
        let reshape8_out1 = add17_out1.reshape([-1, 729, 16, 72]);
        ...
        let reshape9_out1 = transpose9_out1.reshape([-1, 729, 1152]);
        ...
        let add28_out1 = (constant53_out1)
            .unsqueeze_dims(&[0isize, 1isize])
            .add(linear15_out1);
        let reshape10_out1 = add26_out1.reshape([-1, 729, 16, 72]);
        let reshape11_out1 = add27_out1.reshape([-1, 729, 16, 72]);
        let reshape12_out1 = add28_out1.reshape([-1, 729, 16, 72]);
        ...
        let reshape13_out1 = transpose13_out1.reshape([-1, 729, 1152]);
...
impl<B: Backend> Submodule3<B> {
    ...
    pub fn forward(
        ...
        let add39_out1 = (constant69_out1)
            .unsqueeze_dims(&[0isize, 1isize])
            .add(linear21_out1);
        let reshape14_out1 = add37_out1.reshape([-1, 729, 16, 72]);
        let reshape15_out1 = add38_out1.reshape([-1, 729, 16, 72]);
        let reshape16_out1 = add39_out1.reshape([-1, 729, 16, 72]);
        ...
        let reshape17_out1 = transpose17_out1.reshape([-1, 729, 1152]);
...
impl<B: Backend> Submodule4<B> {
    ...
    pub fn forward(
        ...
        let add50_out1 = (constant85_out1)
            .unsqueeze_dims(&[0isize, 1isize])
            .add(linear27_out1);
        let reshape18_out1 = add48_out1.reshape([-1, 729, 16, 72]);
        let reshape19_out1 = add49_out1.reshape([-1, 729, 16, 72]);
        let reshape20_out1 = add50_out1.reshape([-1, 729, 16, 72]);
        ...
        let reshape21_out1 = transpose21_out1.reshape([-1, 729, 1152]);
        ...
        let add61_out1 = (constant101_out1)
            .unsqueeze_dims(&[0isize, 1isize])
            .add(linear33_out1);
        let reshape22_out1 = add59_out1.reshape([-1, 729, 16, 72]);
        let reshape23_out1 = add60_out1.reshape([-1, 729, 16, 72]);
        let reshape24_out1 = add61_out1.reshape([-1, 729, 16, 72]);
        ...
        let reshape25_out1 = transpose25_out1.reshape([-1, 729, 1152]);
...
impl<B: Backend> Submodule5<B> {
    ...
    pub fn forward(
        ...
        let add72_out1 = (constant117_out1)
            .unsqueeze_dims(&[0isize, 1isize])
            .add(linear39_out1);
        let reshape26_out1 = add70_out1.reshape([-1, 729, 16, 72]);
        let reshape27_out1 = add71_out1.reshape([-1, 729, 16, 72]);
        let reshape28_out1 = add72_out1.reshape([-1, 729, 16, 72]);
        ...
        let reshape29_out1 = transpose29_out1.reshape([-1, 729, 1152]);
...
impl<B: Backend> Submodule6<B> {
    ...
    pub fn forward(
        ...
        let add83_out1 = (constant133_out1)
            .unsqueeze_dims(&[0isize, 1isize])
            .add(linear45_out1);
        let reshape30_out1 = add81_out1.reshape([-1, 729, 16, 72]);
        let reshape31_out1 = add82_out1.reshape([-1, 729, 16, 72]);
        let reshape32_out1 = add83_out1.reshape([-1, 729, 16, 72]);
        ...
        let reshape33_out1 = transpose33_out1.reshape([-1, 729, 1152]);
        ...
        let add94_out1 = (constant149_out1)
            .unsqueeze_dims(&[0isize, 1isize])
            .add(linear51_out1);
        let reshape34_out1 = add92_out1.reshape([-1, 729, 16, 72]);
        let reshape35_out1 = add93_out1.reshape([-1, 729, 16, 72]);
        let reshape36_out1 = add94_out1.reshape([-1, 729, 16, 72]);
        ...
        let reshape37_out1 = transpose37_out1.reshape([-1, 729, 1152]);
...
impl<B: Backend> Submodule7<B> {
    ...
    pub fn forward(
        ...
        let add105_out1 = (constant165_out1)
            .unsqueeze_dims(&[0isize, 1isize])
            .add(linear57_out1);
        let reshape38_out1 = add103_out1.reshape([-1, 729, 16, 72]);
        let reshape39_out1 = add104_out1.reshape([-1, 729, 16, 72]);
        let reshape40_out1 = add105_out1.reshape([-1, 729, 16, 72]);
        ...
        let reshape41_out1 = transpose41_out1.reshape([-1, 729, 1152]);
...
impl<B: Backend> Submodule8<B> {
    ...
    pub fn forward(
        ...
        let add116_out1 = (constant181_out1)
            .unsqueeze_dims(&[0isize, 1isize])
            .add(linear63_out1);
        let reshape42_out1 = add114_out1.reshape([-1, 729, 16, 72]);
        let reshape43_out1 = add115_out1.reshape([-1, 729, 16, 72]);
        let reshape44_out1 = add116_out1.reshape([-1, 729, 16, 72]);
        ...
        let reshape45_out1 = transpose45_out1.reshape([-1, 729, 1152]);
        ...
        let add127_out1 = (constant197_out1)
            .unsqueeze_dims(&[0isize, 1isize])
            .add(linear69_out1);
        let reshape46_out1 = add125_out1.reshape([-1, 729, 16, 72]);
        let reshape47_out1 = add126_out1.reshape([-1, 729, 16, 72]);
        let reshape48_out1 = add127_out1.reshape([-1, 729, 16, 72]);
        ...
        let reshape49_out1 = transpose49_out1.reshape([-1, 729, 1152]);
...
impl<B: Backend> Submodule9<B> {
    ...
    pub fn forward(
        ...
        let add137_out1 = (constant212_out1)
            .unsqueeze_dims(&[0isize, 1isize])
            .add(linear74_out1);
        let constant213_out1 = self.constant213.val();
        let add138_out1 = (constant213_out1)
            .unsqueeze_dims(&[0isize, 1isize])
            .add(linear75_out1);
        let reshape50_out1 = add136_out1.reshape([-1, 729, 16, 72]);
        let reshape51_out1 = add137_out1.reshape([-1, 729, 16, 72]);
        let reshape52_out1 = add138_out1.reshape([-1, 729, 16, 72]);
        let transpose50_out1 = reshape50_out1.permute([0, 2, 1, 3]);
        let transpose51_out1 = reshape52_out1.permute([0, 2, 1, 3]);
        let transpose52_out1 = reshape51_out1.permute([0, 2, 3, 1]);
        let matmul100_k_corrected = transpose52_out1.permute([0, 1, 3, 2]);
        let (matmul101_out1,) = {
            let q = transpose50_out1;
            let k = matmul100_k_corrected;
            let v = transpose51_out1;
        ...
        let transpose53_out1 = matmul101_out1.permute([0, 2, 1, 3]);
        let reshape53_out1 = transpose53_out1.reshape([-1, 729, 1152]);
        ...
        let add140_out1 = reducemean52_out1.add((constant6_out1).unsqueeze_dims(&[0isize, 1isize]));
        let sqrt26_out1 = add140_out1.sqrt();
        let div26_out1 = sub26_out1.div(sqrt26_out1);
        let constant216_out1 = self.constant216.val();
        let mul124_out1 = div26_out1.mul((constant216_out1).unsqueeze_dims(&[0isize, 1isize]));
        let constant217_out1 = self.constant217.val();
        let add141_out1 = mul124_out1.add((constant217_out1).unsqueeze_dims(&[0isize, 1isize]));
...
pub struct Submodule10<B: Backend> {
    ...
    constant244: burn::module::Param<Tensor<B, 1>>,
...
impl<B: Backend> Submodule10<B> {
    ...
    pub fn new(device: &B::Device) -> Self {
        ...
        let constant244: burn::module::Param<Tensor<B, 1>> = burn::module::Param::uninitialized(
            burn::module::ParamId::new(),
            move |device, _require_grad| {
                Tensor::<B, 1>::zeros([1152], (device, burn::tensor::DType::F32))
            },
    ...
    pub fn forward(
        ...
        let add145_out1 =
            reducemean54_out1.add((constant6_out1.clone()).unsqueeze_dims(&[0isize, 1isize]));
        let sqrt27_out1 = add145_out1.sqrt();
        let div27_out1 = sub27_out1.div(sqrt27_out1);
        let constant222_out1 = self.constant222.val();
        let mul131_out1 = div27_out1.mul((constant222_out1).unsqueeze_dims(&[0isize, 1isize]));
        let constant223_out1 = self.constant223.val();
        let add146_out1 = mul131_out1.add((constant223_out1).unsqueeze_dims(&[0isize, 1isize]));
        ...
        let add147_out1 = (constant227_out1)
            .unsqueeze_dims(&[0isize, 1isize])
            .add(linear79_out1);
        let constant228_out1 = self.constant228.val();
        let add148_out1 = (constant228_out1)
            .unsqueeze_dims(&[0isize, 1isize])
            .add(linear80_out1);
        let constant229_out1 = self.constant229.val();
        let add149_out1 = (constant229_out1)
            .unsqueeze_dims(&[0isize, 1isize])
            .add(linear81_out1);
        let reshape54_out1 = add147_out1.reshape([-1, 729, 16, 72]);
        let reshape55_out1 = add148_out1.reshape([-1, 729, 16, 72]);
        let reshape56_out1 = add149_out1.reshape([-1, 729, 16, 72]);
        let transpose54_out1 = reshape54_out1.permute([0, 2, 1, 3]);
        let transpose55_out1 = reshape56_out1.permute([0, 2, 1, 3]);
        let transpose56_out1 = reshape55_out1.permute([0, 2, 3, 1]);
        let matmul108_k_corrected = transpose56_out1.permute([0, 1, 3, 2]);
        let (matmul109_out1,) = {
            let q = transpose54_out1;
            let k = matmul108_k_corrected;
            let v = transpose55_out1;
        ...
        let transpose57_out1 = matmul109_out1.permute([0, 2, 1, 3]);
        let reshape57_out1 = transpose57_out1.reshape([-1, 729, 1152]);
        ...
        let add151_out1 =
            reducemean56_out1.add((constant6_out1.clone()).unsqueeze_dims(&[0isize, 1isize]));
        let sqrt28_out1 = add151_out1.sqrt();
        let div28_out1 = sub28_out1.div(sqrt28_out1);
        let constant232_out1 = self.constant232.val();
        let mul134_out1 = div28_out1.mul((constant232_out1).unsqueeze_dims(&[0isize, 1isize]));
        let constant233_out1 = self.constant233.val();
        let add152_out1 = mul134_out1.add((constant233_out1).unsqueeze_dims(&[0isize, 1isize]));
        ...
        let add156_out1 = reducemean58_out1.add((constant6_out1).unsqueeze_dims(&[0isize, 1isize]));
        let sqrt29_out1 = add156_out1.sqrt();
        let div29_out1 = sub29_out1.div(sqrt29_out1);
        let constant238_out1 = self.constant238.val();
        let mul141_out1 = div29_out1.mul((constant238_out1).unsqueeze_dims(&[0isize, 1isize]));
        let constant239_out1 = self.constant239.val();
        let add157_out1 = mul141_out1.add((constant239_out1).unsqueeze_dims(&[0isize, 1isize]));
        ...
        let add158_out1 = (constant243_out1)
            .unsqueeze_dims(&[0isize, 1isize])
            .add(linear85_out1);
        let constant244_out1 = self.constant244.val();
        let add159_out1 = (constant244_out1)
            .unsqueeze_dims(&[0isize, 1isize])
            .add(linear86_out1);
        let constant245_out1 = self.constant245.val();
        let add160_out1 = (constant245_out1)
            .unsqueeze_dims(&[0isize, 1isize])
            .add(linear87_out1);
        let reshape58_out1 = add158_out1.reshape([-1, 729, 16, 72]);
        let reshape59_out1 = add159_out1.reshape([-1, 729, 16, 72]);
        let reshape60_out1 = add160_out1.reshape([-1, 729, 16, 72]);
        let transpose58_out1 = reshape58_out1.permute([0, 2, 1, 3]);
        let transpose59_out1 = reshape60_out1.permute([0, 2, 1, 3]);
        let transpose60_out1 = reshape59_out1.permute([0, 2, 3, 1]);
        let matmul116_k_corrected = transpose60_out1.permute([0, 1, 3, 2]);
        let (matmul117_out1,) = {
            let q = transpose58_out1;
            let k = matmul116_k_corrected;
            let v = transpose59_out1;
        ...
        let transpose61_out1 = matmul117_out1.permute([0, 2, 1, 3]);
        let reshape61_out1 = transpose61_out1.reshape([-1, 729, 1152]);
...
pub struct Submodule11<B: Backend> {
    ...
    constant260: burn::module::Param<Tensor<B, 1>>,
    constant261: burn::module::Param<Tensor<B, 1>>,
    linear94: Linear<B>,
...
impl<B: Backend> Submodule11<B> {
    ...
    pub fn new(device: &B::Device) -> Self {
        ...
        let constant260: burn::module::Param<Tensor<B, 1>> = burn::module::Param::uninitialized(
            burn::module::ParamId::new(),
            move |device, _require_grad| {
                Tensor::<B, 1>::zeros([1152], (device, burn::tensor::DType::F32))
            },
        ...
        let constant261: burn::module::Param<Tensor<B, 1>> = burn::module::Param::uninitialized(
            burn::module::ParamId::new(),
            move |device, _require_grad| {
                Tensor::<B, 1>::zeros([1152], (device, burn::tensor::DType::F32))
            },
    ...
    pub fn forward(
        ...
        let add162_out1 =
            reducemean60_out1.add((constant6_out1.clone()).unsqueeze_dims(&[0isize, 1isize]));
        let sqrt30_out1 = add162_out1.sqrt();
        let div30_out1 = sub30_out1.div(sqrt30_out1);
        let constant248_out1 = self.constant248.val();
        let mul144_out1 = div30_out1.mul((constant248_out1).unsqueeze_dims(&[0isize, 1isize]));
        let constant249_out1 = self.constant249.val();
        let add163_out1 = mul144_out1.add((constant249_out1).unsqueeze_dims(&[0isize, 1isize]));
        ...
        let mul147_out1 = (constant24_out1.clone())
            .unsqueeze_dims(&[0isize, 1isize])
            .mul(mul146_out1);
        let add164_out1 = linear89_out1.clone().add(mul147_out1);
        let mul148_out1 = (constant25_out1.clone())
            .unsqueeze_dims(&[0isize, 1isize])
            .mul(add164_out1);
        let tanh15_out1 = mul148_out1.tanh();
        let add165_out1 = (constant26_out1.clone())
            .unsqueeze_dims(&[0isize, 1isize])
            .add(tanh15_out1);
        let mul149_out1 = linear89_out1.mul(add165_out1);
        let mul150_out1 = (constant27_out1.clone())
            .unsqueeze_dims(&[0isize, 1isize])
            .mul(mul149_out1);
        ...
        let add167_out1 =
            reducemean62_out1.add((constant6_out1.clone()).unsqueeze_dims(&[0isize, 1isize]));
        let sqrt31_out1 = add167_out1.sqrt();
        let div31_out1 = sub31_out1.div(sqrt31_out1);
        let constant254_out1 = self.constant254.val();
        let mul151_out1 = div31_out1.mul((constant254_out1).unsqueeze_dims(&[0isize, 1isize]));
        let constant255_out1 = self.constant255.val();
        let add168_out1 = mul151_out1.add((constant255_out1).unsqueeze_dims(&[0isize, 1isize]));
        ...
        let add169_out1 = (constant259_out1)
            .unsqueeze_dims(&[0isize, 1isize])
            .add(linear91_out1);
        let constant260_out1 = self.constant260.val();
        let add170_out1 = (constant260_out1)
            .unsqueeze_dims(&[0isize, 1isize])
            .add(linear92_out1);
        let constant261_out1 = self.constant261.val();
        let add171_out1 = (constant261_out1)
            .unsqueeze_dims(&[0isize, 1isize])
            .add(linear93_out1);
        let reshape62_out1 = add169_out1.reshape([-1, 729, 16, 72]);
        let reshape63_out1 = add170_out1.reshape([-1, 729, 16, 72]);
        let reshape64_out1 = add171_out1.reshape([-1, 729, 16, 72]);
        let transpose62_out1 = reshape62_out1.permute([0, 2, 1, 3]);
        let transpose63_out1 = reshape64_out1.permute([0, 2, 1, 3]);
        let transpose64_out1 = reshape63_out1.permute([0, 2, 3, 1]);
        let matmul124_k_corrected = transpose64_out1.permute([0, 1, 3, 2]);
        let (matmul125_out1,) = {
            let q = transpose62_out1;
            let k = matmul124_k_corrected;
            let v = transpose63_out1;
        ...
        let transpose65_out1 = matmul125_out1.permute([0, 2, 1, 3]);
        let reshape65_out1 = transpose65_out1.reshape([-1, 729, 1152]);
        ...
        let add173_out1 = reducemean64_out1.add((constant6_out1).unsqueeze_dims(&[0isize, 1isize]));
        let sqrt32_out1 = add173_out1.sqrt();
        let div32_out1 = sub32_out1.div(sqrt32_out1);
        let constant264_out1 = self.constant264.val();
        let mul154_out1 = div32_out1.mul((constant264_out1).unsqueeze_dims(&[0isize, 1isize]));
        let constant265_out1 = self.constant265.val();
        let add174_out1 = mul154_out1.add((constant265_out1).unsqueeze_dims(&[0isize, 1isize]));
...
pub struct Submodule12<B: Backend> {
    constant270: burn::module::Param<Tensor<B, 1>>,
    constant271: burn::module::Param<Tensor<B, 1>>,
    linear97: Linear<B>,
    linear98: Linear<B>,
    linear99: Linear<B>,
    constant275: burn::module::Param<Tensor<B, 1>>,
    constant276: burn::module::Param<Tensor<B, 1>>,
    constant277: burn::module::Param<Tensor<B, 1>>,
    linear100: Linear<B>,
    constant280: burn::module::Param<Tensor<B, 1>>,
    constant281: burn::module::Param<Tensor<B, 1>>,
    linear101: Linear<B>,
    linear102: Linear<B>,
    constant286: burn::module::Param<Tensor<B, 1>>,
    constant287: burn::module::Param<Tensor<B, 1>>,
    linear103: Linear<B>,
    linear104: Linear<B>,
    linear105: Linear<B>,
    constant291: burn::module::Param<Tensor<B, 1>>,
    constant292: burn::module::Param<Tensor<B, 1>>,
    constant293: burn::module::Param<Tensor<B, 1>>,
    linear106: Linear<B>,
    phantom: core::marker::PhantomData<B>,
    #[module(skip)]
    device: B::Device,
...
impl<B: Backend> Submodule12<B> {
    #[allow(unused_variables)]
    pub fn new(device: &B::Device) -> Self {
        let constant270: burn::module::Param<Tensor<B, 1>> = burn::module::Param::uninitialized(
            burn::module::ParamId::new(),
            move |device, _require_grad| {
                Tensor::<B, 1>::zeros([1152], (device, burn::tensor::DType::F32))
            },
        ...
        let constant276: burn::module::Param<Tensor<B, 1>> = burn::module::Param::uninitialized(
            burn::module::ParamId::new(),
            move |device, _require_grad| {
                Tensor::<B, 1>::zeros([1152], (device, burn::tensor::DType::F32))
            },
        ...
        let constant277: burn::module::Param<Tensor<B, 1>> = burn::module::Param::uninitialized(
            burn::module::ParamId::new(),
            move |device, _require_grad| {
                Tensor::<B, 1>::zeros([1152], (device, burn::tensor::DType::F32))
            },
        ...
        let constant286: burn::module::Param<Tensor<B, 1>> = burn::module::Param::uninitialized(
            burn::module::ParamId::new(),
            move |device, _require_grad| {
                Tensor::<B, 1>::zeros([1152], (device, burn::tensor::DType::F32))
            },
        ...
        let constant287: burn::module::Param<Tensor<B, 1>> = burn::module::Param::uninitialized(
            burn::module::ParamId::new(),
            move |device, _require_grad| {
                Tensor::<B, 1>::zeros([1152], (device, burn::tensor::DType::F32))
            },
        ...
        let constant292: burn::module::Param<Tensor<B, 1>> = burn::module::Param::uninitialized(
            burn::module::ParamId::new(),
            move |device, _require_grad| {
                Tensor::<B, 1>::zeros([1152], (device, burn::tensor::DType::F32))
            },
        ...
        let constant293: burn::module::Param<Tensor<B, 1>> = burn::module::Param::uninitialized(
            burn::module::ParamId::new(),
            move |device, _require_grad| {
                Tensor::<B, 1>::zeros([1152], (device, burn::tensor::DType::F32))
            },
    ...
    pub fn forward(
        ...
        let add178_out1 =
            reducemean66_out1.add((constant6_out1.clone()).unsqueeze_dims(&[0isize, 1isize]));
        let sqrt33_out1 = add178_out1.sqrt();
        let div33_out1 = sub33_out1.div(sqrt33_out1);
        let constant270_out1 = self.constant270.val();
        let mul161_out1 = div33_out1.mul((constant270_out1).unsqueeze_dims(&[0isize, 1isize]));
        let constant271_out1 = self.constant271.val();
        let add179_out1 = mul161_out1.add((constant271_out1).unsqueeze_dims(&[0isize, 1isize]));
        ...
        let add180_out1 = (constant275_out1)
            .unsqueeze_dims(&[0isize, 1isize])
            .add(linear97_out1);
        let constant276_out1 = self.constant276.val();
        let add181_out1 = (constant276_out1)
            .unsqueeze_dims(&[0isize, 1isize])
            .add(linear98_out1);
        let constant277_out1 = self.constant277.val();
        let add182_out1 = (constant277_out1)
            .unsqueeze_dims(&[0isize, 1isize])
            .add(linear99_out1);
        let reshape66_out1 = add180_out1.reshape([-1, 729, 16, 72]);
        let reshape67_out1 = add181_out1.reshape([-1, 729, 16, 72]);
        let reshape68_out1 = add182_out1.reshape([-1, 729, 16, 72]);
        let transpose66_out1 = reshape66_out1.permute([0, 2, 1, 3]);
        let transpose67_out1 = reshape68_out1.permute([0, 2, 1, 3]);
        let transpose68_out1 = reshape67_out1.permute([0, 2, 3, 1]);
        let matmul132_k_corrected = transpose68_out1.permute([0, 1, 3, 2]);
        let (matmul133_out1,) = {
            let q = transpose66_out1;
            let k = matmul132_k_corrected;
            let v = transpose67_out1;
        ...
        let transpose69_out1 = matmul133_out1.permute([0, 2, 1, 3]);
        let reshape69_out1 = transpose69_out1.reshape([-1, 729, 1152]);
        ...
        let add184_out1 =
            reducemean68_out1.add((constant6_out1.clone()).unsqueeze_dims(&[0isize, 1isize]));
        let sqrt34_out1 = add184_out1.sqrt();
        let div34_out1 = sub34_out1.div(sqrt34_out1);
        let constant280_out1 = self.constant280.val();
        let mul164_out1 = div34_out1.mul((constant280_out1).unsqueeze_dims(&[0isize, 1isize]));
        let constant281_out1 = self.constant281.val();
        let add185_out1 = mul164_out1.add((constant281_out1).unsqueeze_dims(&[0isize, 1isize]));
        ...
        let add189_out1 = reducemean70_out1.add((constant6_out1).unsqueeze_dims(&[0isize, 1isize]));
        let sqrt35_out1 = add189_out1.sqrt();
        let div35_out1 = sub35_out1.div(sqrt35_out1);
        let constant286_out1 = self.constant286.val();
        let mul171_out1 = div35_out1.mul((constant286_out1).unsqueeze_dims(&[0isize, 1isize]));
        let constant287_out1 = self.constant287.val();
        let add190_out1 = mul171_out1.add((constant287_out1).unsqueeze_dims(&[0isize, 1isize]));
        ...
        let add191_out1 = (constant291_out1)
            .unsqueeze_dims(&[0isize, 1isize])
            .add(linear103_out1);
        let constant292_out1 = self.constant292.val();
        let add192_out1 = (constant292_out1)
            .unsqueeze_dims(&[0isize, 1isize])
            .add(linear104_out1);
        let constant293_out1 = self.constant293.val();
        let add193_out1 = (constant293_out1)
            .unsqueeze_dims(&[0isize, 1isize])
            .add(linear105_out1);
        let reshape70_out1 = add191_out1.reshape([-1, 729, 16, 72]);
        let reshape71_out1 = add192_out1.reshape([-1, 729, 16, 72]);
        let reshape72_out1 = add193_out1.reshape([-1, 729, 16, 72]);
        let transpose70_out1 = reshape70_out1.permute([0, 2, 1, 3]);
        let transpose71_out1 = reshape72_out1.permute([0, 2, 1, 3]);
        let transpose72_out1 = reshape71_out1.permute([0, 2, 3, 1]);
        let matmul140_k_corrected = transpose72_out1.permute([0, 1, 3, 2]);
        let (matmul141_out1,) = {
            let q = transpose70_out1;
            let k = matmul140_k_corrected;
            let v = transpose71_out1;
        ...
        let transpose73_out1 = matmul141_out1.permute([0, 2, 1, 3]);
        let reshape73_out1 = transpose73_out1.reshape([-1, 729, 1152]);
...
pub struct Submodule13<B: Backend> {
    ...
    linear107: Linear<B>,
    linear108: Linear<B>,
    constant302: burn::module::Param<Tensor<B, 1>>,
    constant303: burn::module::Param<Tensor<B, 1>>,
    linear109: Linear<B>,
    linear110: Linear<B>,
    linear111: Linear<B>,
    constant307: burn::module::Param<Tensor<B, 1>>,
    constant308: burn::module::Param<Tensor<B, 1>>,
...
impl<B: Backend> Submodule13<B> {
    ...
    pub fn new(device: &B::Device) -> Self {
        ...
        let constant302: burn::module::Param<Tensor<B, 1>> = burn::module::Param::uninitialized(
            burn::module::ParamId::new(),
            move |device, _require_grad| {
                Tensor::<B, 1>::zeros([1152], (device, burn::tensor::DType::F32))
            },
        ...
        let constant308: burn::module::Param<Tensor<B, 1>> = burn::module::Param::uninitialized(
            burn::module::ParamId::new(),
            move |device, _require_grad| {
                Tensor::<B, 1>::zeros([1152], (device, burn::tensor::DType::F32))
            },
    ...
    pub fn forward(
        ...
        let add195_out1 =
            reducemean72_out1.add((constant6_out1.clone()).unsqueeze_dims(&[0isize, 1isize]));
        let sqrt36_out1 = add195_out1.sqrt();
        let div36_out1 = sub36_out1.div(sqrt36_out1);
        let constant296_out1 = self.constant296.val();
        let mul174_out1 = div36_out1.mul((constant296_out1).unsqueeze_dims(&[0isize, 1isize]));
        let constant297_out1 = self.constant297.val();
        let add196_out1 = mul174_out1.add((constant297_out1).unsqueeze_dims(&[0isize, 1isize]));
        ...
        let mul177_out1 = (constant24_out1.clone())
            .unsqueeze_dims(&[0isize, 1isize])
            .mul(mul176_out1);
        let add197_out1 = linear107_out1.clone().add(mul177_out1);
        let mul178_out1 = (constant25_out1.clone())
            .unsqueeze_dims(&[0isize, 1isize])
            .mul(add197_out1);
        let tanh18_out1 = mul178_out1.tanh();
        let add198_out1 = (constant26_out1.clone())
            .unsqueeze_dims(&[0isize, 1isize])
            .add(tanh18_out1);
        let mul179_out1 = linear107_out1.mul(add198_out1);
        let mul180_out1 = (constant27_out1.clone())
            .unsqueeze_dims(&[0isize, 1isize])
            .mul(mul179_out1);
        ...
        let add200_out1 =
            reducemean74_out1.add((constant6_out1.clone()).unsqueeze_dims(&[0isize, 1isize]));
        let sqrt37_out1 = add200_out1.sqrt();
        let div37_out1 = sub37_out1.div(sqrt37_out1);
        let constant302_out1 = self.constant302.val();
        let mul181_out1 = div37_out1.mul((constant302_out1).unsqueeze_dims(&[0isize, 1isize]));
        let constant303_out1 = self.constant303.val();
        let add201_out1 = mul181_out1.add((constant303_out1).unsqueeze_dims(&[0isize, 1isize]));
        ...
        let add202_out1 = (constant307_out1)
            .unsqueeze_dims(&[0isize, 1isize])
            .add(linear109_out1);
        let constant308_out1 = self.constant308.val();
        let add203_out1 = (constant308_out1)
            .unsqueeze_dims(&[0isize, 1isize])
            .add(linear110_out1);
        let constant309_out1 = self.constant309.val();
        let add204_out1 = (constant309_out1)
            .unsqueeze_dims(&[0isize, 1isize])
            .add(linear111_out1);
        let reshape74_out1 = add202_out1.reshape([-1, 729, 16, 72]);
        let reshape75_out1 = add203_out1.reshape([-1, 729, 16, 72]);
        let reshape76_out1 = add204_out1.reshape([-1, 729, 16, 72]);
        let transpose74_out1 = reshape74_out1.permute([0, 2, 1, 3]);
        let transpose75_out1 = reshape76_out1.permute([0, 2, 1, 3]);
        let transpose76_out1 = reshape75_out1.permute([0, 2, 3, 1]);
        let matmul148_k_corrected = transpose76_out1.permute([0, 1, 3, 2]);
        let (matmul149_out1,) = {
            let q = transpose74_out1;
            let k = matmul148_k_corrected;
            let v = transpose75_out1;
        ...
        let transpose77_out1 = matmul149_out1.permute([0, 2, 1, 3]);
        let reshape77_out1 = transpose77_out1.reshape([-1, 729, 1152]);
        ...
        let add206_out1 = reducemean76_out1.add((constant6_out1).unsqueeze_dims(&[0isize, 1isize]));
        let sqrt38_out1 = add206_out1.sqrt();
        let div38_out1 = sub38_out1.div(sqrt38_out1);
        let constant312_out1 = self.constant312.val();
        let mul184_out1 = div38_out1.mul((constant312_out1).unsqueeze_dims(&[0isize, 1isize]));
        let constant313_out1 = self.constant313.val();
        let add207_out1 = mul184_out1.add((constant313_out1).unsqueeze_dims(&[0isize, 1isize]));
...
pub struct Submodule14<B: Backend> {
    ...
    constant324: burn::module::Param<Tensor<B, 1>>,
    constant325: burn::module::Param<Tensor<B, 1>>,
    linear118: Linear<B>,
    ...
    constant341: burn::module::Param<Tensor<B, 1>>,
    linear124: Linear<B>,
    phantom: core::marker::PhantomData<B>,
    #[module(skip)]
    device: B::Device,
...
impl<B: Backend> Submodule14<B> {
    ...
    pub fn new(device: &B::Device) -> Self {
        ...
        let constant324: burn::module::Param<Tensor<B, 1>> = burn::module::Param::uninitialized(
            burn::module::ParamId::new(),
            move |device, _require_grad| {
                Tensor::<B, 1>::zeros([1152], (device, burn::tensor::DType::F32))
            },
        ...
        let constant325: burn::module::Param<Tensor<B, 1>> = burn::module::Param::uninitialized(
            burn::module::ParamId::new(),
            move |device, _require_grad| {
                Tensor::<B, 1>::zeros([1152], (device, burn::tensor::DType::F32))
            },
        ...
        let constant341: burn::module::Param<Tensor<B, 1>> = burn::module::Param::uninitialized(
            burn::module::ParamId::new(),
            move |device, _require_grad| {
                Tensor::<B, 1>::zeros([1152], (device, burn::tensor::DType::F32))
            },
    ...
    pub fn forward(
        ...
        let add211_out1 =
            reducemean78_out1.add((constant6_out1.clone()).unsqueeze_dims(&[0isize, 1isize]));
        let sqrt39_out1 = add211_out1.sqrt();
        let div39_out1 = sub39_out1.div(sqrt39_out1);
        let constant318_out1 = self.constant318.val();
        let mul191_out1 = div39_out1.mul((constant318_out1).unsqueeze_dims(&[0isize, 1isize]));
        let constant319_out1 = self.constant319.val();
        let add212_out1 = mul191_out1.add((constant319_out1).unsqueeze_dims(&[0isize, 1isize]));
        ...
        let add213_out1 = (constant323_out1)
            .unsqueeze_dims(&[0isize, 1isize])
            .add(linear115_out1);
        let constant324_out1 = self.constant324.val();
        let add214_out1 = (constant324_out1)
            .unsqueeze_dims(&[0isize, 1isize])
            .add(linear116_out1);
        let constant325_out1 = self.constant325.val();
        let add215_out1 = (constant325_out1)
            .unsqueeze_dims(&[0isize, 1isize])
            .add(linear117_out1);
        let reshape78_out1 = add213_out1.reshape([-1, 729, 16, 72]);
        let reshape79_out1 = add214_out1.reshape([-1, 729, 16, 72]);
        let reshape80_out1 = add215_out1.reshape([-1, 729, 16, 72]);
        let transpose78_out1 = reshape78_out1.permute([0, 2, 1, 3]);
        let transpose79_out1 = reshape80_out1.permute([0, 2, 1, 3]);
        let transpose80_out1 = reshape79_out1.permute([0, 2, 3, 1]);
        let matmul156_k_corrected = transpose80_out1.permute([0, 1, 3, 2]);
        let (matmul157_out1,) = {
            let q = transpose78_out1;
            let k = matmul156_k_corrected;
            let v = transpose79_out1;
        ...
        let transpose81_out1 = matmul157_out1.permute([0, 2, 1, 3]);
        let reshape81_out1 = transpose81_out1.reshape([-1, 729, 1152]);
        ...
        let add217_out1 =
            reducemean80_out1.add((constant6_out1.clone()).unsqueeze_dims(&[0isize, 1isize]));
        let sqrt40_out1 = add217_out1.sqrt();
        let div40_out1 = sub40_out1.div(sqrt40_out1);
        let constant328_out1 = self.constant328.val();
        let mul194_out1 = div40_out1.mul((constant328_out1).unsqueeze_dims(&[0isize, 1isize]));
        let constant329_out1 = self.constant329.val();
        let add218_out1 = mul194_out1.add((constant329_out1).unsqueeze_dims(&[0isize, 1isize]));
        ...
        let add222_out1 = reducemean82_out1.add((constant6_out1).unsqueeze_dims(&[0isize, 1isize]));
        let sqrt41_out1 = add222_out1.sqrt();
        let div41_out1 = sub41_out1.div(sqrt41_out1);
        let constant334_out1 = self.constant334.val();
        let mul201_out1 = div41_out1.mul((constant334_out1).unsqueeze_dims(&[0isize, 1isize]));
        let constant335_out1 = self.constant335.val();
        let add223_out1 = mul201_out1.add((constant335_out1).unsqueeze_dims(&[0isize, 1isize]));
        ...
        let add224_out1 = (constant339_out1)
            .unsqueeze_dims(&[0isize, 1isize])
            .add(linear121_out1);
        let constant340_out1 = self.constant340.val();
        let add225_out1 = (constant340_out1)
            .unsqueeze_dims(&[0isize, 1isize])
            .add(linear122_out1);
        let constant341_out1 = self.constant341.val();
        let add226_out1 = (constant341_out1)
            .unsqueeze_dims(&[0isize, 1isize])
            .add(linear123_out1);
        let reshape82_out1 = add224_out1.reshape([-1, 729, 16, 72]);
        let reshape83_out1 = add225_out1.reshape([-1, 729, 16, 72]);
        let reshape84_out1 = add226_out1.reshape([-1, 729, 16, 72]);
        let transpose82_out1 = reshape82_out1.permute([0, 2, 1, 3]);
        let transpose83_out1 = reshape84_out1.permute([0, 2, 1, 3]);
        let transpose84_out1 = reshape83_out1.permute([0, 2, 3, 1]);
        let matmul164_k_corrected = transpose84_out1.permute([0, 1, 3, 2]);
        let (matmul165_out1,) = {
            let q = transpose82_out1;
            let k = matmul164_k_corrected;
            let v = transpose83_out1;
        ...
        let transpose85_out1 = matmul165_out1.permute([0, 2, 1, 3]);
        let reshape85_out1 = transpose85_out1.reshape([-1, 729, 1152]);
...
pub struct Submodule15<B: Backend> {
    ...
    constant351: burn::module::Param<Tensor<B, 1>>,
    linear127: Linear<B>,
    linear128: Linear<B>,
    linear129: Linear<B>,
...
impl<B: Backend> Submodule15<B> {
    ...
    pub fn new(device: &B::Device) -> Self {
        ...
        let constant351: burn::module::Param<Tensor<B, 1>> = burn::module::Param::uninitialized(
            burn::module::ParamId::new(),
            move |device, _require_grad| {
                Tensor::<B, 1>::zeros([1152], (device, burn::tensor::DType::F32))
            },
    ...
    pub fn forward(
        ...
        let add228_out1 =
            reducemean84_out1.add((constant6_out1.clone()).unsqueeze_dims(&[0isize, 1isize]));
        let sqrt42_out1 = add228_out1.sqrt();
        let div42_out1 = sub42_out1.div(sqrt42_out1);
        let constant344_out1 = self.constant344.val();
        let mul204_out1 = div42_out1.mul((constant344_out1).unsqueeze_dims(&[0isize, 1isize]));
        let constant345_out1 = self.constant345.val();
        let add229_out1 = mul204_out1.add((constant345_out1).unsqueeze_dims(&[0isize, 1isize]));
        ...
        let mul207_out1 = (constant24_out1.clone())
            .unsqueeze_dims(&[0isize, 1isize])
            .mul(mul206_out1);
        let add230_out1 = linear125_out1.clone().add(mul207_out1);
        let mul208_out1 = (constant25_out1.clone())
            .unsqueeze_dims(&[0isize, 1isize])
            .mul(add230_out1);
        let tanh21_out1 = mul208_out1.tanh();
        let add231_out1 = (constant26_out1.clone())
            .unsqueeze_dims(&[0isize, 1isize])
            .add(tanh21_out1);
        let mul209_out1 = linear125_out1.mul(add231_out1);
        let mul210_out1 = (constant27_out1.clone())
            .unsqueeze_dims(&[0isize, 1isize])
            .mul(mul209_out1);
        ...
        let add233_out1 =
            reducemean86_out1.add((constant6_out1.clone()).unsqueeze_dims(&[0isize, 1isize]));
        let sqrt43_out1 = add233_out1.sqrt();
        let div43_out1 = sub43_out1.div(sqrt43_out1);
        let constant350_out1 = self.constant350.val();
        let mul211_out1 = div43_out1.mul((constant350_out1).unsqueeze_dims(&[0isize, 1isize]));
        let constant351_out1 = self.constant351.val();
        let add234_out1 = mul211_out1.add((constant351_out1).unsqueeze_dims(&[0isize, 1isize]));
        ...
        let add235_out1 = (constant355_out1)
            .unsqueeze_dims(&[0isize, 1isize])
            .add(linear127_out1);
        let constant356_out1 = self.constant356.val();
        let add236_out1 = (constant356_out1)
            .unsqueeze_dims(&[0isize, 1isize])
            .add(linear128_out1);
        let constant357_out1 = self.constant357.val();
        let add237_out1 = (constant357_out1)
            .unsqueeze_dims(&[0isize, 1isize])
            .add(linear129_out1);
        let reshape86_out1 = add235_out1.reshape([-1, 729, 16, 72]);
        let reshape87_out1 = add236_out1.reshape([-1, 729, 16, 72]);
        let reshape88_out1 = add237_out1.reshape([-1, 729, 16, 72]);
        let transpose86_out1 = reshape86_out1.permute([0, 2, 1, 3]);
        let transpose87_out1 = reshape88_out1.permute([0, 2, 1, 3]);
        let transpose88_out1 = reshape87_out1.permute([0, 2, 3, 1]);
        let matmul172_k_corrected = transpose88_out1.permute([0, 1, 3, 2]);
        let (matmul173_out1,) = {
            let q = transpose86_out1;
            let k = matmul172_k_corrected;
            let v = transpose87_out1;
        ...
        let transpose89_out1 = matmul173_out1.permute([0, 2, 1, 3]);
        let reshape89_out1 = transpose89_out1.reshape([-1, 729, 1152]);
        ...
        let add239_out1 = reducemean88_out1.add((constant6_out1).unsqueeze_dims(&[0isize, 1isize]));
        let sqrt44_out1 = add239_out1.sqrt();
        let div44_out1 = sub44_out1.div(sqrt44_out1);
        let constant360_out1 = self.constant360.val();
        let mul214_out1 = div44_out1.mul((constant360_out1).unsqueeze_dims(&[0isize, 1isize]));
        let constant361_out1 = self.constant361.val();
        let add240_out1 = mul214_out1.add((constant361_out1).unsqueeze_dims(&[0isize, 1isize]));
...
pub struct Submodule16<B: Backend> {
    constant366: burn::module::Param<Tensor<B, 1>>,
    constant367: burn::module::Param<Tensor<B, 1>>,
    linear133: Linear<B>,
    linear134: Linear<B>,
    linear135: Linear<B>,
    ...
    linear137: Linear<B>,
    linear138: Linear<B>,
    constant382: burn::module::Param<Tensor<B, 1>>,
    constant383: burn::module::Param<Tensor<B, 1>>,
    linear139: Linear<B>,
    linear140: Linear<B>,
    linear141: Linear<B>,
    constant387: burn::module::Param<Tensor<B, 1>>,
    constant388: burn::module::Param<Tensor<B, 1>>,
    constant389: burn::module::Param<Tensor<B, 1>>,
    linear142: Linear<B>,
    phantom: core::marker::PhantomData<B>,
    #[module(skip)]
    device: B::Device,
...
impl<B: Backend> Submodule16<B> {
    #[allow(unused_variables)]
    pub fn new(device: &B::Device) -> Self {
        let constant366: burn::module::Param<Tensor<B, 1>> = burn::module::Param::uninitialized(
            burn::module::ParamId::new(),
            move |device, _require_grad| {
                Tensor::<B, 1>::zeros([1152], (device, burn::tensor::DType::F32))
            },
        ...
        let constant367: burn::module::Param<Tensor<B, 1>> = burn::module::Param::uninitialized(
            burn::module::ParamId::new(),
            move |device, _require_grad| {
                Tensor::<B, 1>::zeros([1152], (device, burn::tensor::DType::F32))
            },
        ...
        let constant382: burn::module::Param<Tensor<B, 1>> = burn::module::Param::uninitialized(
            burn::module::ParamId::new(),
            move |device, _require_grad| {
                Tensor::<B, 1>::zeros([1152], (device, burn::tensor::DType::F32))
            },
        ...
        let constant383: burn::module::Param<Tensor<B, 1>> = burn::module::Param::uninitialized(
            burn::module::ParamId::new(),
            move |device, _require_grad| {
                Tensor::<B, 1>::zeros([1152], (device, burn::tensor::DType::F32))
            },
        ...
        let constant388: burn::module::Param<Tensor<B, 1>> = burn::module::Param::uninitialized(
            burn::module::ParamId::new(),
            move |device, _require_grad| {
                Tensor::<B, 1>::zeros([1152], (device, burn::tensor::DType::F32))
            },
        ...
        let constant389: burn::module::Param<Tensor<B, 1>> = burn::module::Param::uninitialized(
            burn::module::ParamId::new(),
            move |device, _require_grad| {
                Tensor::<B, 1>::zeros([1152], (device, burn::tensor::DType::F32))
            },
    ...
    pub fn forward(
        ...
        let add244_out1 =
            reducemean90_out1.add((constant6_out1.clone()).unsqueeze_dims(&[0isize, 1isize]));
        let sqrt45_out1 = add244_out1.sqrt();
        let div45_out1 = sub45_out1.div(sqrt45_out1);
        let constant366_out1 = self.constant366.val();
        let mul221_out1 = div45_out1.mul((constant366_out1).unsqueeze_dims(&[0isize, 1isize]));
        let constant367_out1 = self.constant367.val();
        let add245_out1 = mul221_out1.add((constant367_out1).unsqueeze_dims(&[0isize, 1isize]));
        ...
        let add246_out1 = (constant371_out1)
            .unsqueeze_dims(&[0isize, 1isize])
            .add(linear133_out1);
        let constant372_out1 = self.constant372.val();
        let add247_out1 = (constant372_out1)
            .unsqueeze_dims(&[0isize, 1isize])
            .add(linear134_out1);
        let constant373_out1 = self.constant373.val();
        let add248_out1 = (constant373_out1)
            .unsqueeze_dims(&[0isize, 1isize])
            .add(linear135_out1);
        let reshape90_out1 = add246_out1.reshape([-1, 729, 16, 72]);
        let reshape91_out1 = add247_out1.reshape([-1, 729, 16, 72]);
        let reshape92_out1 = add248_out1.reshape([-1, 729, 16, 72]);
        let transpose90_out1 = reshape90_out1.permute([0, 2, 1, 3]);
        let transpose91_out1 = reshape92_out1.permute([0, 2, 1, 3]);
        let transpose92_out1 = reshape91_out1.permute([0, 2, 3, 1]);
        let matmul180_k_corrected = transpose92_out1.permute([0, 1, 3, 2]);
        let (matmul181_out1,) = {
            let q = transpose90_out1;
            let k = matmul180_k_corrected;
            let v = transpose91_out1;
        ...
        let transpose93_out1 = matmul181_out1.permute([0, 2, 1, 3]);
        let reshape93_out1 = transpose93_out1.reshape([-1, 729, 1152]);
        ...
        let add250_out1 =
            reducemean92_out1.add((constant6_out1.clone()).unsqueeze_dims(&[0isize, 1isize]));
        let sqrt46_out1 = add250_out1.sqrt();
        let div46_out1 = sub46_out1.div(sqrt46_out1);
        let constant376_out1 = self.constant376.val();
        let mul224_out1 = div46_out1.mul((constant376_out1).unsqueeze_dims(&[0isize, 1isize]));
        let constant377_out1 = self.constant377.val();
        let add251_out1 = mul224_out1.add((constant377_out1).unsqueeze_dims(&[0isize, 1isize]));
        ...
        let add255_out1 = reducemean94_out1.add((constant6_out1).unsqueeze_dims(&[0isize, 1isize]));
        let sqrt47_out1 = add255_out1.sqrt();
        let div47_out1 = sub47_out1.div(sqrt47_out1);
        let constant382_out1 = self.constant382.val();
        let mul231_out1 = div47_out1.mul((constant382_out1).unsqueeze_dims(&[0isize, 1isize]));
        let constant383_out1 = self.constant383.val();
        let add256_out1 = mul231_out1.add((constant383_out1).unsqueeze_dims(&[0isize, 1isize]));
        ...
        let add257_out1 = (constant387_out1)
            .unsqueeze_dims(&[0isize, 1isize])
            .add(linear139_out1);
        let constant388_out1 = self.constant388.val();
        let add258_out1 = (constant388_out1)
            .unsqueeze_dims(&[0isize, 1isize])
            .add(linear140_out1);
        let constant389_out1 = self.constant389.val();
        let add259_out1 = (constant389_out1)
            .unsqueeze_dims(&[0isize, 1isize])
            .add(linear141_out1);
        let reshape94_out1 = add257_out1.reshape([-1, 729, 16, 72]);
        let reshape95_out1 = add258_out1.reshape([-1, 729, 16, 72]);
        let reshape96_out1 = add259_out1.reshape([-1, 729, 16, 72]);
        let transpose94_out1 = reshape94_out1.permute([0, 2, 1, 3]);
        let transpose95_out1 = reshape96_out1.permute([0, 2, 1, 3]);
        let transpose96_out1 = reshape95_out1.permute([0, 2, 3, 1]);
        let matmul188_k_corrected = transpose96_out1.permute([0, 1, 3, 2]);
        let (matmul189_out1,) = {
            let q = transpose94_out1;
            let k = matmul188_k_corrected;
            let v = transpose95_out1;
        ...
        let transpose97_out1 = matmul189_out1.permute([0, 2, 1, 3]);
        let reshape97_out1 = transpose97_out1.reshape([-1, 729, 1152]);
...
pub struct Submodule17<B: Backend> {
    ...
    linear143: Linear<B>,
    linear144: Linear<B>,
    constant398: burn::module::Param<Tensor<B, 1>>,
    constant399: burn::module::Param<Tensor<B, 1>>,
    linear145: Linear<B>,
    linear146: Linear<B>,
    linear147: Linear<B>,
    constant403: burn::module::Param<Tensor<B, 1>>,
    constant404: burn::module::Param<Tensor<B, 1>>,
    constant405: burn::module::Param<Tensor<B, 1>>,
    linear148: Linear<B>,
...
impl<B: Backend> Submodule17<B> {
    ...
    pub fn new(device: &B::Device) -> Self {
        ...
        let constant398: burn::module::Param<Tensor<B, 1>> = burn::module::Param::uninitialized(
            burn::module::ParamId::new(),
            move |device, _require_grad| {
                Tensor::<B, 1>::zeros([1152], (device, burn::tensor::DType::F32))
            },
        ...
        let constant399: burn::module::Param<Tensor<B, 1>> = burn::module::Param::uninitialized(
            burn::module::ParamId::new(),
            move |device, _require_grad| {
                Tensor::<B, 1>::zeros([1152], (device, burn::tensor::DType::F32))
            },
        ...
        let constant405: burn::module::Param<Tensor<B, 1>> = burn::module::Param::uninitialized(
            burn::module::ParamId::new(),
            move |device, _require_grad| {
                Tensor::<B, 1>::zeros([1152], (device, burn::tensor::DType::F32))
            },
    ...
    pub fn forward(
        ...
        let add261_out1 =
            reducemean96_out1.add((constant6_out1.clone()).unsqueeze_dims(&[0isize, 1isize]));
        let sqrt48_out1 = add261_out1.sqrt();
        let div48_out1 = sub48_out1.div(sqrt48_out1);
        let constant392_out1 = self.constant392.val();
        let mul234_out1 = div48_out1.mul((constant392_out1).unsqueeze_dims(&[0isize, 1isize]));
        let constant393_out1 = self.constant393.val();
        let add262_out1 = mul234_out1.add((constant393_out1).unsqueeze_dims(&[0isize, 1isize]));
        ...
        let mul237_out1 = (constant24_out1.clone())
            .unsqueeze_dims(&[0isize, 1isize])
            .mul(mul236_out1);
        let add263_out1 = linear143_out1.clone().add(mul237_out1);
        let mul238_out1 = (constant25_out1.clone())
            .unsqueeze_dims(&[0isize, 1isize])
            .mul(add263_out1);
        let tanh24_out1 = mul238_out1.tanh();
        let add264_out1 = (constant26_out1.clone())
            .unsqueeze_dims(&[0isize, 1isize])
            .add(tanh24_out1);
        let mul239_out1 = linear143_out1.mul(add264_out1);
        let mul240_out1 = (constant27_out1.clone())
            .unsqueeze_dims(&[0isize, 1isize])
            .mul(mul239_out1);
        ...
        let add266_out1 =
            reducemean98_out1.add((constant6_out1.clone()).unsqueeze_dims(&[0isize, 1isize]));
        let sqrt49_out1 = add266_out1.sqrt();
        let div49_out1 = sub49_out1.div(sqrt49_out1);
        let constant398_out1 = self.constant398.val();
        let mul241_out1 = div49_out1.mul((constant398_out1).unsqueeze_dims(&[0isize, 1isize]));
        let constant399_out1 = self.constant399.val();
        let add267_out1 = mul241_out1.add((constant399_out1).unsqueeze_dims(&[0isize, 1isize]));
        ...
        let add268_out1 = (constant403_out1)
            .unsqueeze_dims(&[0isize, 1isize])
            .add(linear145_out1);
        let constant404_out1 = self.constant404.val();
        let add269_out1 = (constant404_out1)
            .unsqueeze_dims(&[0isize, 1isize])
            .add(linear146_out1);
        let constant405_out1 = self.constant405.val();
        let add270_out1 = (constant405_out1)
            .unsqueeze_dims(&[0isize, 1isize])
            .add(linear147_out1);
        let reshape98_out1 = add268_out1.reshape([-1, 729, 16, 72]);
        let reshape99_out1 = add269_out1.reshape([-1, 729, 16, 72]);
        let reshape100_out1 = add270_out1.reshape([-1, 729, 16, 72]);
        let transpose98_out1 = reshape98_out1.permute([0, 2, 1, 3]);
        let transpose99_out1 = reshape100_out1.permute([0, 2, 1, 3]);
        let transpose100_out1 = reshape99_out1.permute([0, 2, 3, 1]);
        let matmul196_k_corrected = transpose100_out1.permute([0, 1, 3, 2]);
        let (matmul197_out1,) = {
            let q = transpose98_out1;
            let k = matmul196_k_corrected;
            let v = transpose99_out1;
        ...
        let transpose101_out1 = matmul197_out1.permute([0, 2, 1, 3]);
        let reshape101_out1 = transpose101_out1.reshape([-1, 729, 1152]);
        let linear148_out1 = self.linear148.forward(reshape101_out1);
        ...
        let add272_out1 =
            reducemean100_out1.add((constant6_out1).unsqueeze_dims(&[0isize, 1isize]));
        let sqrt50_out1 = add272_out1.sqrt();
        let div50_out1 = sub50_out1.div(sqrt50_out1);
        let constant408_out1 = self.constant408.val();
        let mul244_out1 = div50_out1.mul((constant408_out1).unsqueeze_dims(&[0isize, 1isize]));
        let constant409_out1 = self.constant409.val();
        let add273_out1 = mul244_out1.add((constant409_out1).unsqueeze_dims(&[0isize, 1isize]));
...
pub struct Submodule18<B: Backend> {
    constant414: burn::module::Param<Tensor<B, 1>>,
    constant415: burn::module::Param<Tensor<B, 1>>,
    linear151: Linear<B>,
    linear152: Linear<B>,
    linear153: Linear<B>,
    constant419: burn::module::Param<Tensor<B, 1>>,
    constant420: burn::module::Param<Tensor<B, 1>>,
    constant421: burn::module::Param<Tensor<B, 1>>,
    linear154: Linear<B>,
    constant424: burn::module::Param<Tensor<B, 1>>,
    constant425: burn::module::Param<Tensor<B, 1>>,
    linear155: Linear<B>,
    linear156: Linear<B>,
    constant430: burn::module::Param<Tensor<B, 1>>,
    constant431: burn::module::Param<Tensor<B, 1>>,
    linear157: Linear<B>,
    linear158: Linear<B>,
    linear159: Linear<B>,
...
impl<B: Backend> Submodule18<B> {
    #[allow(unused_variables)]
    pub fn new(device: &B::Device) -> Self {
        let constant414: burn::module::Param<Tensor<B, 1>> = burn::module::Param::uninitialized(
            burn::module::ParamId::new(),
            move |device, _require_grad| {
                Tensor::<B, 1>::zeros([1152], (device, burn::tensor::DType::F32))
            },
        ...
        let constant415: burn::module::Param<Tensor<B, 1>> = burn::module::Param::uninitialized(
            burn::module::ParamId::new(),
            move |device, _require_grad| {
                Tensor::<B, 1>::zeros([1152], (device, burn::tensor::DType::F32))
            },
        ...
        let constant420: burn::module::Param<Tensor<B, 1>> = burn::module::Param::uninitialized(
            burn::module::ParamId::new(),
            move |device, _require_grad| {
                Tensor::<B, 1>::zeros([1152], (device, burn::tensor::DType::F32))
            },
        ...
        let constant421: burn::module::Param<Tensor<B, 1>> = burn::module::Param::uninitialized(
            burn::module::ParamId::new(),
            move |device, _require_grad| {
                Tensor::<B, 1>::zeros([1152], (device, burn::tensor::DType::F32))
            },
        ...
        let constant430: burn::module::Param<Tensor<B, 1>> = burn::module::Param::uninitialized(
            burn::module::ParamId::new(),
            move |device, _require_grad| {
                Tensor::<B, 1>::zeros([1152], (device, burn::tensor::DType::F32))
            },
        ...
        let constant431: burn::module::Param<Tensor<B, 1>> = burn::module::Param::uninitialized(
            burn::module::ParamId::new(),
            move |device, _require_grad| {
                Tensor::<B, 1>::zeros([1152], (device, burn::tensor::DType::F32))
            },
    ...
    pub fn forward(
        ...
        let add277_out1 =
            reducemean102_out1.add((constant6_out1.clone()).unsqueeze_dims(&[0isize, 1isize]));
        let sqrt51_out1 = add277_out1.sqrt();
        let div51_out1 = sub51_out1.div(sqrt51_out1);
        let constant414_out1 = self.constant414.val();
        let mul251_out1 = div51_out1.mul((constant414_out1).unsqueeze_dims(&[0isize, 1isize]));
        let constant415_out1 = self.constant415.val();
        let add278_out1 = mul251_out1.add((constant415_out1).unsqueeze_dims(&[0isize, 1isize]));
        ...
        let add279_out1 = (constant419_out1)
            .unsqueeze_dims(&[0isize, 1isize])
            .add(linear151_out1);
        let constant420_out1 = self.constant420.val();
        let add280_out1 = (constant420_out1)
            .unsqueeze_dims(&[0isize, 1isize])
            .add(linear152_out1);
        let constant421_out1 = self.constant421.val();
        let add281_out1 = (constant421_out1)
            .unsqueeze_dims(&[0isize, 1isize])
            .add(linear153_out1);
        let reshape102_out1 = add279_out1.reshape([-1, 729, 16, 72]);
        let reshape103_out1 = add280_out1.reshape([-1, 729, 16, 72]);
        let reshape104_out1 = add281_out1.reshape([-1, 729, 16, 72]);
        let transpose102_out1 = reshape102_out1.permute([0, 2, 1, 3]);
        let transpose103_out1 = reshape104_out1.permute([0, 2, 1, 3]);
        let transpose104_out1 = reshape103_out1.permute([0, 2, 3, 1]);
        let matmul204_k_corrected = transpose104_out1.permute([0, 1, 3, 2]);
        let (matmul205_out1,) = {
            let q = transpose102_out1;
            let k = matmul204_k_corrected;
            let v = transpose103_out1;
        ...
        let transpose105_out1 = matmul205_out1.permute([0, 2, 1, 3]);
        let reshape105_out1 = transpose105_out1.reshape([-1, 729, 1152]);
        let linear154_out1 = self.linear154.forward(reshape105_out1);
        ...
        let add283_out1 =
            reducemean104_out1.add((constant6_out1.clone()).unsqueeze_dims(&[0isize, 1isize]));
        let sqrt52_out1 = add283_out1.sqrt();
        let div52_out1 = sub52_out1.div(sqrt52_out1);
        let constant424_out1 = self.constant424.val();
        let mul254_out1 = div52_out1.mul((constant424_out1).unsqueeze_dims(&[0isize, 1isize]));
        let constant425_out1 = self.constant425.val();
        let add284_out1 = mul254_out1.add((constant425_out1).unsqueeze_dims(&[0isize, 1isize]));
        ...
        let add288_out1 =
            reducemean106_out1.add((constant6_out1).unsqueeze_dims(&[0isize, 1isize]));
        let sqrt53_out1 = add288_out1.sqrt();
        let div53_out1 = sub53_out1.div(sqrt53_out1);
        let constant430_out1 = self.constant430.val();
        let mul261_out1 = div53_out1.mul((constant430_out1).unsqueeze_dims(&[0isize, 1isize]));
        let constant431_out1 = self.constant431.val();
        let add289_out1 = mul261_out1.add((constant431_out1).unsqueeze_dims(&[0isize, 1isize]));
        ...
        let add290_out1 = (constant435_out1)
            .unsqueeze_dims(&[0isize, 1isize])
            .add(linear157_out1);
        let constant436_out1 = self.constant436.val();
        let add291_out1 = (constant436_out1)
            .unsqueeze_dims(&[0isize, 1isize])
            .add(linear158_out1);
        let constant437_out1 = self.constant437.val();
        let add292_out1 = (constant437_out1)
            .unsqueeze_dims(&[0isize, 1isize])
            .add(linear159_out1);
        let reshape106_out1 = add290_out1.reshape([-1, 729, 16, 72]);
        let reshape107_out1 = add291_out1.reshape([-1, 729, 16, 72]);
        let reshape108_out1 = add292_out1.reshape([-1, 729, 16, 72]);
        let transpose106_out1 = reshape106_out1.permute([0, 2, 1, 3]);
        let transpose107_out1 = reshape108_out1.permute([0, 2, 1, 3]);
        let transpose108_out1 = reshape107_out1.permute([0, 2, 3, 1]);
        let matmul212_k_corrected = transpose108_out1.permute([0, 1, 3, 2]);
        let (matmul213_out1,) = {
            let q = transpose106_out1;
            let k = matmul212_k_corrected;
            let v = transpose107_out1;
        ...
        let transpose109_out1 = matmul213_out1.permute([0, 2, 1, 3]);
        let reshape109_out1 = transpose109_out1.reshape([-1, 729, 1152]);
        let linear160_out1 = self.linear160.forward(reshape109_out1);
...
pub struct Submodule19<B: Backend> {
    ...
    linear161: Linear<B>,
    linear162: Linear<B>,
    constant446: burn::module::Param<Tensor<B, 1>>,
    constant447: burn::module::Param<Tensor<B, 1>>,
    linear163: Linear<B>,
    constant451: burn::module::Param<Tensor<B, 1>>,
    constant454: burn::module::Param<Tensor<B, 3>>,
    linear164: Linear<B>,
    constant457: burn::module::Param<Tensor<B, 1>>,
    constant461: burn::module::Param<Tensor<B, 1>>,
    linear165: Linear<B>,
    constant466: burn::module::Param<Tensor<B, 1>>,
    constant467: burn::module::Param<Tensor<B, 1>>,
    linear166: Linear<B>,
    linear167: Linear<B>,
    phantom: core::marker::PhantomData<B>,
    #[module(skip)]
...
impl<B: Backend> Submodule19<B> {
    ...
    pub fn new(device: &B::Device) -> Self {
        ...
        let constant446: burn::module::Param<Tensor<B, 1>> = burn::module::Param::uninitialized(
            burn::module::ParamId::new(),
            move |device, _require_grad| {
                Tensor::<B, 1>::zeros([1152], (device, burn::tensor::DType::F32))
            },
        ...
        let constant447: burn::module::Param<Tensor<B, 1>> = burn::module::Param::uninitialized(
            burn::module::ParamId::new(),
            move |device, _require_grad| {
                Tensor::<B, 1>::zeros([1152], (device, burn::tensor::DType::F32))
            },
        ...
        let linear163 = LinearConfig::new(1152, 2304).with_bias(false).init(device);
        let constant451: burn::module::Param<Tensor<B, 1>> = burn::module::Param::uninitialized(
            burn::module::ParamId::new(),
            move |device, _require_grad| {
                Tensor::<B, 1>::zeros([2304], (device, burn::tensor::DType::F32))
            },
            device.clone(),
            false,
            [2304].into(),
        );
        let constant454: burn::module::Param<Tensor<B, 3>> = burn::module::Param::uninitialized(
            burn::module::ParamId::new(),
            move |device, _require_grad| {
                Tensor::<B, 3>::zeros([1, 1, 1152], (device, burn::tensor::DType::F32))
            },
            device.clone(),
            false,
            [1, 1, 1152].into(),
        );
        let linear164 = LinearConfig::new(1152, 1152).with_bias(false).init(device);
        ...
        let constant461: burn::module::Param<Tensor<B, 1>> = burn::module::Param::uninitialized(
            burn::module::ParamId::new(),
            move |device, _require_grad| {
                Tensor::<B, 1>::from_data(
                    burn::tensor::TensorData::from([0.1178511306643486f64]),
                    (device, burn::tensor::DType::F32),
                )
            },
            device.clone(),
        ...
        let linear165 = LinearConfig::new(1152, 1152)
            .with_bias(true)
            .with_layout(LinearLayout::Col)
            .init(device);
        let constant466: burn::module::Param<Tensor<B, 1>> = burn::module::Param::uninitialized(
            burn::module::ParamId::new(),
            move |device, _require_grad| {
                Tensor::<B, 1>::zeros([1152], (device, burn::tensor::DType::F32))
            },
        ...
        let constant467: burn::module::Param<Tensor<B, 1>> = burn::module::Param::uninitialized(
            burn::module::ParamId::new(),
            move |device, _require_grad| {
                Tensor::<B, 1>::zeros([1152], (device, burn::tensor::DType::F32))
            },
        ...
        let linear166 = LinearConfig::new(1152, 4304).with_bias(true).init(device);
        let linear167 = LinearConfig::new(4304, 1152).with_bias(true).init(device);
        Self {
            constant440,
            constant441,
            linear161,
    ...
    pub fn forward(
        ...
        let add294_out1 =
            reducemean108_out1.add((constant6_out1.clone()).unsqueeze_dims(&[0isize, 1isize]));
        let sqrt54_out1 = add294_out1.sqrt();
        let div54_out1 = sub54_out1.div(sqrt54_out1);
        let constant440_out1 = self.constant440.val();
        let mul264_out1 = div54_out1.mul((constant440_out1).unsqueeze_dims(&[0isize, 1isize]));
        let constant441_out1 = self.constant441.val();
        let add295_out1 = mul264_out1.add((constant441_out1).unsqueeze_dims(&[0isize, 1isize]));
        ...
        let mul267_out1 = (constant24_out1.clone())
            .unsqueeze_dims(&[0isize, 1isize])
            .mul(mul266_out1);
        let add296_out1 = linear161_out1.clone().add(mul267_out1);
        let mul268_out1 = (constant25_out1.clone())
            .unsqueeze_dims(&[0isize, 1isize])
            .mul(add296_out1);
        let tanh27_out1 = mul268_out1.tanh();
        let add297_out1 = (constant26_out1.clone())
            .unsqueeze_dims(&[0isize, 1isize])
            .add(tanh27_out1);
        let mul269_out1 = linear161_out1.mul(add297_out1);
        let mul270_out1 = (constant27_out1.clone())
            .unsqueeze_dims(&[0isize, 1isize])
            .mul(mul269_out1);
        ...
        let add299_out1 =
            reducemean110_out1.add((constant6_out1.clone()).unsqueeze_dims(&[0isize, 1isize]));
        let sqrt55_out1 = add299_out1.sqrt();
        let div55_out1 = sub55_out1.div(sqrt55_out1);
        let constant446_out1 = self.constant446.val();
        let mul271_out1 = div55_out1.mul((constant446_out1).unsqueeze_dims(&[0isize, 1isize]));
        let constant447_out1 = self.constant447.val();
        let add300_out1 = mul271_out1.add((constant447_out1).unsqueeze_dims(&[0isize, 1isize]));
        let shape1_out1: [i64; 3] = {
            let axes = &add300_out1.clone().dims()[0..3];
        ...
        let transpose110_out1 = add300_out1.clone().permute([1, 0, 2]);
        let gather1_out1 = shape1_out1[0] as i64;
        let linear163_out1 = self.linear163.forward(transpose110_out1);
        let unsqueeze1_out1 = [gather1_out1 as i64];
        let constant451_out1 = self.constant451.val();
        let add301_out1 = (constant451_out1)
            .unsqueeze_dims(&[0isize, 1isize])
            .add(linear163_out1);
        ...
        .try_into()
        .unwrap();
        let reshape110_out1 = add301_out1.reshape([729, -1, 2, 1152]);
        let constant454_out1 = self.constant454.val();
        let tile1_out1 = {
            let __repeats: alloc::vec::Vec<usize> =
                concat1_out1.iter().map(|&v| v as usize).collect();
            constant454_out1.repeat(&__repeats)
        };
        let unsqueeze2_out1: Tensor<B, 5> = reshape110_out1.unsqueeze_dims::<5>(&[0]);
        let transpose111_out1 = tile1_out1.permute([1, 0, 2]);
        let transpose112_out1 = unsqueeze2_out1.permute([3, 1, 2, 0, 4]);
        let linear164_out1 = self.linear164.forward(transpose111_out1);
        let squeeze1_out1 = transpose112_out1.squeeze_dims::<4>(&[3]);
        let constant457_out1 = self.constant457.val();
        let add302_out1 = (constant457_out1)
            .unsqueeze_dims(&[0isize, 1isize])
            .add(linear164_out1);
        let gather2_out1 = {
        ...
        let reshape111_out1 = add302_out1.reshape([1, -1, 72]);
        let reshape112_out1 = gather2_out1.reshape([729, -1, 72]);
        let reshape113_out1 = gather3_out1.reshape([729, -1, 72]);
        let transpose113_out1 = reshape111_out1.permute([1, 0, 2]);
        let transpose114_out1 = reshape113_out1.permute([1, 0, 2]);
        let transpose115_out1 = reshape112_out1.permute([1, 2, 0]);
        let constant461_out1 = self.constant461.val();
        let mul272_out1 =
            transpose113_out1.mul((constant461_out1).unsqueeze_dims(&[0isize, 1isize]));
        let matmul219_out1 = mul272_out1.matmul(transpose115_out1);
        let softmax28_out1 = burn::tensor::activation::softmax(matmul219_out1, 2);
        let matmul220_out1 = softmax28_out1.matmul(transpose114_out1);
        let transpose116_out1 = matmul220_out1.permute([1, 0, 2]);
        let reshape114_out1 = transpose116_out1.reshape([-1, 1152]);
        let linear165_out1 = self.linear165.forward(reshape114_out1);
        let reshape115_out1 = linear165_out1.reshape([1, -1, 1152]);
        let transpose117_out1 = reshape115_out1.permute([1, 0, 2]);
        let reducemean111_out1 = { transpose117_out1.clone().mean_dim(2usize) };
        let sub56_out1 = transpose117_out1.clone().sub(reducemean111_out1);
        let pow56_out1 = sub56_out1
            .clone()
            .powf((constant5_out1).unsqueeze_dims(&[0isize, 1isize]));
        let reducemean112_out1 = { pow56_out1.mean_dim(2usize) };
        let add303_out1 =
            reducemean112_out1.add((constant6_out1).unsqueeze_dims(&[0isize, 1isize]));
        let sqrt56_out1 = add303_out1.sqrt();
        let div56_out1 = sub56_out1.div(sqrt56_out1);
        let constant466_out1 = self.constant466.val();
        let mul273_out1 = div56_out1.mul((constant466_out1).unsqueeze_dims(&[0isize, 1isize]));
        let constant467_out1 = self.constant467.val();
        let add304_out1 = mul273_out1.add((constant467_out1).unsqueeze_dims(&[0isize, 1isize]));
        let linear166_out1 = self.linear166.forward(add304_out1);
        let mul274_out1 = linear166_out1.clone().mul(linear166_out1.clone());
        let mul275_out1 = linear166_out1.clone().mul(mul274_out1);
        let mul276_out1 = (constant24_out1)
            .unsqueeze_dims(&[0isize, 1isize])
            .mul(mul275_out1);
        let add305_out1 = linear166_out1.clone().add(mul276_out1);
        let mul277_out1 = (constant25_out1)
            .unsqueeze_dims(&[0isize, 1isize])
            .mul(add305_out1);
        let tanh28_out1 = mul277_out1.tanh();
        let add306_out1 = (constant26_out1)
            .unsqueeze_dims(&[0isize, 1isize])
            .add(tanh28_out1);
        let mul278_out1 = linear166_out1.mul(add306_out1);
        let mul279_out1 = (constant27_out1)
            .unsqueeze_dims(&[0isize, 1isize])
            .mul(mul278_out1);
        let linear167_out1 = self.linear167.forward(mul279_out1);
        let add307_out1 = transpose117_out1.add(linear167_out1);
        let gather4_out1 = {
            let sliced = add307_out1.slice(s![.., 0, ..]);
            sliced.squeeze_dim::<2usize>(1)
        };
        (add300_out1, gather4_out1)
    }
}
...
impl<B: Backend> Default for Model<B> {
    fn default() -> Self {
        Self::from_file(
            "/Volumes/CodeBase/Projects/Burn-Convert/burn_onnx_demo/target/debug/build/burn_onnx_demo-5924b412d15e0ca8/out/model/siglip2-so400m-vision/vision.bpk",
            &Default::default(),
        )
    }
}
...
impl<B: Backend> Model<B> {
    ...
    #[allow(clippy::let_and_return, clippy::approx_constant)]
    pub fn forward(&self, pixel_values: Tensor<B, 4>) -> (Tensor<B, 3>, Tensor<B, 2>) {
        let (
            add12_out1,
            constant5_out1,
            constant6_out1,
        ...
        let add144_out1 = self.submodule9.forward(
            add128_out1,
            constant5_out1.clone(),
            constant6_out1.clone(),
            constant24_out1.clone(),
        ...
        let add161_out1 = self.submodule10.forward(
            add144_out1,
            constant5_out1.clone(),
            constant6_out1.clone(),
            constant24_out1.clone(),
        ...
        let add177_out1 = self.submodule11.forward(
            add161_out1,
            constant5_out1.clone(),
            constant6_out1.clone(),
            constant24_out1.clone(),
        ...
        let add194_out1 = self.submodule12.forward(
            add177_out1,
            constant5_out1.clone(),
            constant6_out1.clone(),
            constant24_out1.clone(),
        ...
        let add210_out1 = self.submodule13.forward(
            add194_out1,
            constant5_out1.clone(),
            constant6_out1.clone(),
            constant24_out1.clone(),
        ...
        let add227_out1 = self.submodule14.forward(
            add210_out1,
            constant5_out1.clone(),
            constant6_out1.clone(),
            constant24_out1.clone(),
        ...
        let add243_out1 = self.submodule15.forward(
            add227_out1,
            constant5_out1.clone(),
            constant6_out1.clone(),
            constant24_out1.clone(),
        ...
        let add260_out1 = self.submodule16.forward(
            add243_out1,
            constant5_out1.clone(),
            constant6_out1.clone(),
            constant24_out1.clone(),
        ...
        let add276_out1 = self.submodule17.forward(
            add260_out1,
            constant5_out1.clone(),
            constant6_out1.clone(),
            constant24_out1.clone(),
        ...
        let add293_out1 = self.submodule18.forward(
            add276_out1,
            constant5_out1.clone(),
            constant6_out1.clone(),
            constant24_out1.clone(),
        ...
        let (add300_out1, gather4_out1) = self.submodule19.forward(
            add293_out1,
            constant5_out1,
            constant6_out1,
            constant24_out1,
