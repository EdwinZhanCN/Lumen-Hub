// Generated from ONNX "onnx/aesthetic-head-siglip2-so400m-patch14-384/aesthetic.prepared.onnx" by burn-onnx
use burn::prelude::*;
use burn::nn::Linear;
...
impl<B: Backend> Default for Model<B> {
    fn default() -> Self {
        Self::from_file(
            "/Volumes/CodeBase/Projects/Lumen-Hub/target/debug/build/lumen-convert-269ce0f0418f1d9d/out/aesthetic_head/siglip2_so400m_patch14_384/aesthetic.bpk",
            &Default::default(),
        )
    }
}
...
impl<B: Backend> Model<B> {
    ...
    pub fn new(device: &B::Device) -> Self {
        let linear1 = LinearConfig::new(1152, 1024)
            .with_bias(true)
