// Generated from ONNX "onnx/pp-ocrv5-server/classification.prepared.onnx" by burn-onnx
...
impl<B: Backend> Default for Model<B> {
    fn default() -> Self {
        Self::from_file(
            "/Volumes/CodeBase/Projects/Lumen-Hub/target/release/build/lumen-convert-0036f7b8de134cd6/out/pp_ocrv5_server/classification/classification.bpk",
            &Default::default(),
        )
    }
}
