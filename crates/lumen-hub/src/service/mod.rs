...
pub use tensor::{
    ...
    META_TENSOR_SHAPE, OUTPUT_KIND_TENSOR, PREPROCESS_BIOCLIP2_224_IMAGE, PREPROCESS_CLIP_IMAGE,
    PREPROCESS_INSIGHTFACE_DET, PREPROCESS_PPOCR_DET, PREPROCESS_SIGLIP_IMAGE,
    PREPROCESS_SIGLIP2_BASE_PATCH16_224_IMAGE, PREPROCESS_SIGLIP2_SO400M_PATCH14_384_IMAGE,
