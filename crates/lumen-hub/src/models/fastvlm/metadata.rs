...
pub struct FastVlmMetadata {
    ...
    pub decoder_input_name: &'static str,
    pub decoder_attention_mask_name: &'static str,
    pub decoder_position_ids_name: &'static str,
...
pub const METADATA: FastVlmMetadata = FastVlmMetadata {
    ...
    decoder_input_name: "inputs_embeds",
    decoder_attention_mask_name: "attention_mask",
    decoder_position_ids_name: "position_ids",
