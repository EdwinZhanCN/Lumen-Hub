...
fn main() {
    ...
    let vision = SiglipVisionModel::load("siglip2-base-patch16-224", &vision_path, device.clone())
    ...
    let text = SiglipTextModel::load("siglip2-base-patch16-224", &text_path, device)
