...
Complete example: [`crates/lumen-hub/tools/clip/model_info.example.json`](https://github.com/EdwinZhanCN/Lumen-Hub/blob/main/crates/lumen-hub/tools/clip/model_info.example.json)
